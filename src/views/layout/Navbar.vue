      ...
      <div class="header-avator-con">
        ...
        <div class="user-dropdown-menu-con">
          <Row type="flex" justify="end" align="middle" class="user-dropdown-innercon">
            ...
            <Avatar :src="avatorPhoto" style="background: #2db7f5;margin-left: 10px;"></Avatar>
          </Row>
        </div>
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      avatorPhoto() {
        if(this.userInfo===null &&this.userInfo!=="" && this.userInfo.photo_filename!==""){
            return avator
        }else{
          return this.userInfo.photo_filename
        }
      }
    },
    methods: {
